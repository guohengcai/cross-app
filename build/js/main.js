...
var Template = /** @class */ (function () {
    ...
    Template.prototype.populate = function (id, name, status) {
        ...
        var timestamp = moment(idtime).format('dddd');
